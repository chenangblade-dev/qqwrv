...
GameRules.vCourierAbilities_Normal = {
    ...
    "queenofpain_blink", -- 闪烁1
    "antimage_blink", -- 闪烁2
    "bloodseeker_bloodrage", -- 血怒
    "sandking_burrowstrike", -- 绝地穿刺
    "lion_voodoo", -- 羊1
    "shadow_shaman_voodoo", -- 羊2
    --"centaur_return", -- 反击
    ...
    "lina_fiery_soul", -- 炽魂
    --"necrolyte_sadist", -- 幽冥护罩
    "windrunner_windrun", -- 7.22的A杖风行步
    "phantom_assassin_blur", -- 7.22魅影无形
    "puck_phase_shift", -- 相位转移低概率
    "juggernaut_blade_fury", -- 剑圣转
    ...
    --"luna_lunar_blessing", -- 月之祝福
    "slark_essence_shift", -- 能量转移
    "tiny_craggy_exterior", -- 崎岖外壳
    "invoker_sun_strike", -- 日
    --"medusa_mana_shield", -- 魔法盾
    "invoker_chaos_meteor",-- 陨石
    "pudge_flesh_heap",-- 屠夫皮
    --"rattletrap_overclocking",-- 超速运转
    "dazzle_shallow_grave",-- 薄葬
    "faceless_void_time_walk",-- 时间漫游
    "batrider_firefly",-- 上山
    "muerta_gunslinger",-- 神枪   会炸房
    "zuus_arc_lightning",
    ...
    "doom_bringer_infernal_blade",  -- 炎刃
}

GameRules.vCourierAbilities_Ultimate = {
    "enchantress_untouchable", -- 小鹿大招
    ...
    "void_spirit_astral_step", -- 太虚幻境
    "dragon_knight_elder_dragon_form", -- 古龙形态
    "undying_flesh_golem", -- 血肉傀儡
    "naga_siren_song_of_the_siren", -- 海妖之歌
    "ogre_magi_multicast", -- 多重施法
    "storm_spirit_ball_lightning", -- 蓝猫飞
    "troll_warlord_battle_trance",-- 巨魔大
...
local courier_only = {
    ...
    "dark_willow_shadow_realm", -- 7.22 A杖暗影之境太厉害了
    --"doom_bringer_infernal_blade", -- 7.23  的阎刃
    "skeleton_king_reincarnation", -- 重生
    "muerta_pierce_the_veil",
}

GameRules.CourierOnlyAbilities = courier_only

if io then
    local courier_abilities = table.join(GameRules.vCourierAbilities_Normal, GameRules.vCourierAbilities_Ultimate)
    courier_abilities = table.reverse(courier_abilities)
    local file = io.open("../../../content/dota_addons/da/panorama/scripts/custom_game/npc/courier_abilities.js", "w")
    courier_abilities = JSON:encode(courier_abilities)

    file:write("var courier_abilities = ")
    file:write("'" .. courier_abilities .. "'")
    file:write("\n")
    file:write("GameUI.CourierAbilities = JSON.parse(courier_abilities)")
    file:flush()
    file:close()
end
...
local too_weak = {
    ...
    "disruptor_glimpse",
    "wisp_spirits",
    "hoodwink_sharpshooter_release", -- 取消松鼠大招
    "pudge_eject",
    --下面是新增的删除技能------------------------------------------
    "abaddon_death_coil",--亚巴顿1技能
    "abyssal_underlord_pit_of_malice", -- 大屁股框
    "oracle_fortunes_end",--神域1
    "beastmaster_mark_of_the_beast",--兽王新技能
    "bristleback_hairball",--刚被新技能
    "lycan_howl",--狼人吼
    "lycan_summon_wolves",--狼人招狼
    "lycan_wolf_bite",--狼人恶狼撕咬
    "night_stalker_void",--夜魔1
    "snapfire_gobble_up",--老奶奶血喷大口
    "snapfire_spit_creep",--老奶奶吐
    "spirit_breaker_nether_strike",--白牛大
    "tidehunter_gush",--潮汐口水
    "treant_leech_seed",--大树2
    "treant_living_armor",--大树3
    "tusk_frozen_sigil",--海民新技能
    "undying_decay",--尸王1
    "undying_soul_rip",--尸王2
    "antimage_mana_overload",--敌法技能
    "bounty_hunter_shuriken_toss",--赏金1技能
    "bounty_hunter_wind_walk",--赏金隐身
    "broodmother_silken_bola",--蜘蛛新技能
    "faceless_void_time_dilation",--虚空膨胀
    "faceless_void_time_walk_reverse",--虚空新技能
    "enchantress_enchant",--小鹿招野怪
    "shadow_shaman_ether_shock",--小y1
    "warlock_fatal_bonds",--术士链接
    "omniknight_degen_aura",--全能被动
    "lone_druid_savage_roar",--德鲁伊3技能
    "luna_lucent_beam",--露娜1技能
    "medusa_mystic_snake",--美杜莎秘书银蛇
    "meepo_earthbind",--米波网
    "meepo_ransack",--米波吸血
    "sniper_concussive_grenade",
    "monkey_king_mischief",--72变
    "pangolier_rollup",--滚滚卷土重来
    "pangolier_rollup_stop",--滚滚卷土重来取消
    "templar_assassin_meld",--ta隐匿
    "warlock_upheaval",--术士聚变
    "templar_assassin_trap_teleport",--ta飞雷神
    "terrorblade_reflection",--tb倒影
    "terrorblade_terror_wave",--tb恐惧
    "troll_warlord_whirling_axes_ranged",--巨魔斧头
    "troll_warlord_whirling_axes_melee",--巨魔斧头
    "venomancer_venomous_gale",--剧毒1
    "venomancer_poison_nova",--剧毒大
    "weaver_the_swarm",--蚂蚁1
    "ancient_apparition_cold_feet",--冰魂1
    "ancient_apparition_ice_vortex",--冰魂2
    "tinker_heat_seeking_missile",--tk导弹
    "visage_soul_assumption",--死灵龙2
    "queenofpain_shadow_strike",--女王标
    "dazzle_poison_touch",--戴泽1
    "phantom_assassin_stifling_dagger",--pa标
    "storm_spirit_electric_rave",--蓝猫新技能
    "skywrath_mage_concussive_shot",--天怒2技能
    "silencer_curse_of_the_silent",--沉默1技能
    "silencer_last_word",--沉默3技能
    "phantom_lancer_spirit_lance",--猴子1    
    "enigma_malefice",--谜团1
    "dawnbreaker_land",--锤子A
    "nevermore_necromastery",
    "elder_titan_move_spirit",--大牛移魂
    "tiny_tree_channel",--扔树
    "brewmaster_primal_companion",--元素伙伴
    "rubick_telekinesis_land",--隔空取物着陆
    "beastmaster_drums_of_slom_stop",--停止敲鼓
    "puck_phase_shift",--相位转移
    --"clinkz_strafe",--火雨
    --"clinkz_death_pact",--小骷髅大
    "crystal_maiden_freezing_field_stop",--冰女大
    "meepo_megameepo",
    "meepo_megameepo_fling",
    "muerta_parting_shot",
    "undying_tombstone",
    "leshrac_greater_lightning_storm", -- 虚无主义
    "techies_reactive_tazer", -- 炸弹缴械
    "pangolier_lucky_shot", -- 幸运一击
    "zuus_lightning_hands", -- zhousi手
    "pugna_decrepify", -- 衰老
    "tusk_snowball",
    "necrolyte_sadist",
    ...
    --"zuus_arc_lightning",
    --"muerta_gunslinger",-- 神枪
    "meepo_petrify",--掘地
    "oracle_fates_edict", -- 命运赦令
...
local may_bug = {
    "dawnbreaker_luminosity", -- 破晓晨星 熠熠生辉
    ...
    "faceless_void_time_walk_reverse", -- 移除时间漫游和反向时间漫游
    "faceless_void_time_lock",
    "void_spirit_aether_remnant", -- 移除残阴
    "dark_seer_normal_punch", -- 普通一拳会导致崩溃
    --"obsidian_destroyer_arcane_orb" -- 奥术天球会有BUG了
    "dark_willow_bedlam",
    "medusa_mana_shield",
    "invoker_emp",
...
local invalid = {
    ...
    "broodmother_spin_web", -- 由于性能限制的原因，暂时移除织网
    "treant_eyes_in_the_forest" -- 由于性能限制的原因，暂时移除树眼
}
